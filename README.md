...
[Home](https://iamsmmh.github.io/OmniSource/) · [Compare](https://iamsmmh.github.io/OmniSource/compare/) · [Health](https://iamsmmh.github.io/OmniSource/status/) · [Analytics](https://iamsmmh.github.io/OmniSource/analytics/) · [Install](https://iamsmmh.github.io/OmniSource/install/) · [Search](https://iamsmmh.github.io/OmniSource/search/) · [Favorites](https://iamsmmh.github.io/OmniSource/favorites/) · [Collections](https://iamsmmh.github.io/OmniSource/collections/)

The site is an installable **PWA** with offline shell and "new version available" prompt.
...
_Last sync 2026-09-10 · 71/77 downloads reachable._
...
Every build publishes `/api/` — `apps.json`, `catalog.json`, `health.json`, `analytics.json`, `install.json`, `search-index.json` and more, each with `.gz` and listed in `api/index.json`. Clients: [`sdk/javascript/`](sdk/javascript/) · [`sdk/python/`](sdk/python/) — [API docs](docs/API.md)
...
🟢 stable · 🟡 beta · 🔵 manual · 🔴 unmaintained — plus *Official* / *Community* build and ✅/⚠️ reachability.
