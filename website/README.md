...
build step. It is assembled (with the generated feeds, app pages and API
mirror) into `_site/` by `scripts/build_site.py` and deployed to GitHub
Pages.
...
├── sw.js                    # Service worker v3: offline shell + stale-while-revalidate feeds
